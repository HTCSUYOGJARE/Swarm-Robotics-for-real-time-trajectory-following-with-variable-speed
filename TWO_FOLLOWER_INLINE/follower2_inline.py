...
class TurtleBotFollower:
    def __init__(self):
        ...
        self.pub_cmd_vel = rospy.Publisher('/follower2/cmd_vel', Twist, queue_size=10)
        self.pub_follower_odom = rospy.Publisher('/follower2/odom', Odometry, queue_size=10)
        self.sub_leader_odom = rospy.Subscriber('/leader/odom', Odometry, self.leader_odom_callback)
        self.sub_follower_odom = rospy.Subscriber('/follower2/odom', Odometry, self.follower_odom_callback)
        ...
        self.desired_distance = 0.8  # Desired distance between follower and leader
